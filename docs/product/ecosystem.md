...
В приложении 1 компонент получает данные от сервиса 1 и использует настройки своего контекста. Приложение 2 может использовать ту же основу с другими настройками и независимым состоянием.
...
Перейти к [началу работы](/configurator/getting-started) или вернуться к [обзору Endge](/product/).
