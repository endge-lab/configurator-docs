...
- Общий компонент «VirtualList» (или «VirtualSelect») в @endge/vue или в дизайн-системе: единый API (данные, высота строки, шаблон элемента), внутри — виртуализация. Использовать его везде, где нужен длинный список.
