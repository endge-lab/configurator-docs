...
- **Таблицы (TanStack)**: проверить роли и заголовки виртуализированной HTML-таблицы со скринридером; при необходимости донастроить aria-label и объявление количества строк/столбцов.
...
- Таблицы данных: caption или aria-label, по возможности объявление структуры для скринридера. Виртуализированный TanStack renderer — по документации и проверкам со скринридером.
