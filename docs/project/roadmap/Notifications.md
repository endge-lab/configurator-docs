...
- **Использование**: прямые вызовы в компонентах и сторах (Domain_Widget, schedule store, endge-admin-tabs и др.); строки сообщений и опции передаются каждый раз на месте вызова.
