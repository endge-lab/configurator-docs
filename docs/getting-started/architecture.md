...
**Конфигуратор** — браузерная среда работы с документами. Несколько участников могут обращаться к одному Backend и работать с доступными им Workspace, проектами и окружениями. Backend остаётся владельцем хранения и серверной проверки доступа. Общий сервер не означает совместное редактирование одного текста в реальном времени: сохранение документов использует revisions и обработку конфликтов.
