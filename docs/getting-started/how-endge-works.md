...
Simulation хранит декларативное описание подмен для Project или Composition. Его компиляция проверяет описание и зависимости, но не запускает симуляцию. Доступные способы проверки и направление развития тест-кейсов описаны в [единой среде работы](/getting-started/shared-workspace#тест-кеисы-и-симуляции).
